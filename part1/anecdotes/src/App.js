...
const App = () => {
  ...
  const handleVoteBtnClick = () => {
    ...
    setMostVotesIndex(pointsCopy.indexOf(Math.max(...pointsCopy)));
  };

  const handleNextAnecdoteBtnClick = () => {
  ...
  return (
    <div>
      ...
      <button onClick={handleNextAnecdoteBtnClick}>next anecdote</button>
